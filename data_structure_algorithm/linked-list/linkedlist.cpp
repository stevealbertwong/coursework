/*
see: http://www.bogotobogo.com/cplusplus/linkedlist.php
...
/* hows it different from just passing *head(addr of node) 
and use head instead of dereference the ptr's address 
to get its value
*/
