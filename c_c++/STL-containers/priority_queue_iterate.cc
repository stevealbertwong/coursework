/*
https://stackoverflow.com/questions/4484767/how-to-iterate-over-a-priority-queue/20304856

printing without popping

g++ -std=c++14 priority_queue_iterate.cc -o priority_queue_iterate
*/
#include <queue>
#include <cstdlib>
#include <iostream>
...
int main()
{
    ...
    cout<<endl<<"2nd time printing "<<endl;    
    for(vector<int>::iterator i=tasks.begin();i!=tasks.end();i++)
        cout<<*i<<endl;
